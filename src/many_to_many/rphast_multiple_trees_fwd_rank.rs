...
pub struct RPHASTMultipleTreesFwdRank {
    batch_size: usize,
    ranks: Vec<usize>,
    ...
    fwd_distances: Vec<Option<Box<[Weight]>>>, // lazily initialized distance vec
...
impl RPHASTMultipleTreesFwdRank {
    ...
    pub fn new(
        ...
        RPHASTMultipleTreesFwdRank {
            ...
            fwd_distances: vec![None; num_vertices],
...
impl ManyToManyAlgorithm for RPHASTMultipleTreesFwdRank {
